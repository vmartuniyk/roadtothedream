    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col sm:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:volodimir.martuniyk@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://www.youtube.com/channel/UCtX24l6ZBDkk2vw6f5wUXHQ" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/vmartuniyk" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://www.instagram.com/vmartuniyk/" target="_blank" class="text-white hover:text-gray-400">
